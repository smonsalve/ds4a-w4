...
def filter_df(exchange_val,margin_val,start_date_val,end_date_val):
    dff = df[(df['Exchange']==exchange_val) & (df['Margin']==int(leverage_value)) & (df['Entry time']==start_date_val) & (df['Entry time']==end_date_val)]
    return dff
